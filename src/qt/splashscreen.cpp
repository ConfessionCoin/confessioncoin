    ...
    QSplashScreen(pixmap, f)
{
    ...
    //int paddingLeftCol2         = 220;
    //int paddingTopCol2          = 15;
    int paddingLeftCol2         = 165;
    int paddingTopCol2          = 165;
    int line1 = 0;
    int line2 = 13;
    int line3 = 26;
    int line4 = 39;
    ...
    QString copyrightText3   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The ConfessionCoin developers"));
