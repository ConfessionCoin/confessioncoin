...
public:
    ...
    std::string SendMoney(
        CScript scriptPubKey, int64 nValue, CWalletTx& wtxNew,
        std::string strTxMessage, bool fAskFee=false);
    std::string SendMoneyToDestination(
        const CTxDestination &address, int64 nValue, CWalletTx& wtxNew,
        std::string strTxMessage, bool fAskFee=false);
