    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Confessioncoin address (e.g. J6PwZ6yJAoPvHeB4sJ7Ut5zU2v8tCP9gHd)"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    foreach(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        formatted.append(tr("<b>%1</b> to %2 (%3)").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::CFN, rcp.amount), Qt::escape(rcp.label), rcp.address));
#else
        formatted.append(tr("<b>%1</b> to %2 (%3)").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::CFN, rcp.amount), rcp.label.toHtmlEscaped(), rcp.address));
#endif
    }
    ...
    case WalletModel::AmountWithFeeExceedsBalance:
        QMessageBox::warning(this, tr("Send Coins"),
            ...
            arg(BitcoinUnits::formatWithUnit(BitcoinUnits::CFN, sendstatus.fee)),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
